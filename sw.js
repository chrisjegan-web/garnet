...
const SHELL = ['./', 'index.html', 'trip.json', 'manifest.webmanifest', 'icon-180.png', 'icon-192.png', 'icon-512.png', 'icon-512-maskable.png', 'favicon.ico', 'favicon-32.png', 'favicon-16.png'];
